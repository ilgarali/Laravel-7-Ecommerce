...
<link rel="stylesheet" type="text/css" href="{{asset('front/')}}/styles/checkout.css">
<link rel="stylesheet" type="text/css" href="{{asset('front/')}}/styles/checkout_responsive.css">
@endsection
@section('content')
            ...
            <div class="checkout_form_container">
                <form action="#" id="checkout_form" class="checkout_form">
                    ...
                    <div class="checkout_extra">
                        ...
                        <label for="checkbox_terms"><img src="{{asset('front/')}}/images/check.png" alt=""></label>
                        ...
                        <div>
                            ...
                            <label for="checkbox_account"><img src="{{asset('front/')}}/images/check.png" alt=""></label>
                        ...
                        <div>
                            ...
                            <label for="checkbox_newsletter"><img src="{{asset('front/')}}/images/check.png" alt=""></label>
        ...
        <div class="order checkout_section">
            ...
            <div class="order_list_container">
                ...
                <ul class="order_list">
                    ...
                    <div class="order_list_title">{{$item->model->title}}</div>
                
                  
                    <div class="order_list_value ml-auto"><span style="color:black;font-weight:bold;font-size:15px">{{$item->quantity}} * ${{$item->model->price}}</span> </div>
               
                    </li>
                    @endforeach
                    <li class="d-flex flex-row align-items-center justify-content-start">
                        <div class="order_list_title">Subtotal</div>
                    <div class="order_list_value ml-auto">${{\Cart::getSubTotal()}}</div>
                    </li>
                    <li class="d-flex flex-row align-items-center justify-content-start">
