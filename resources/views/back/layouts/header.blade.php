...
<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
  <div class="navbar-brand-wrapper d-flex justify-content-center">
    ...
    <a class="navbar-brand brand-logo" href="{{route('home')}}"><img src="{{asset('back')}}/images/logo.svg" alt="logo"/></a>
      <a class="navbar-brand brand-logo-mini" href="{{route('home')}}"><img src="{{asset('back')}}/images/logo-mini.svg" alt="logo"/></a>
